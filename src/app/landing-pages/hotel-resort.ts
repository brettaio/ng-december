...
export class HotelResortComponent {
    ...
    items = [
        {
            ...
            thumb: '/assets/images/hotel-resort/room1.jpg',
            type: 'delux-room'
        },
        {
            src: '/assets/images/hotel-resort/room2.jpg',
            thumb: '/assets/images/hotel-resort/room2.jpg',
            type: 'delux-room'
        },
        {
            src: '/assets/images/hotel-resort/room3.jpg',
            thumb: '/assets/images/hotel-resort/room3.jpg',
            type: 'cozy-room'
        },
        {
            src: '/assets/images/hotel-resort/room4.jpg',
            thumb: '/assets/images/hotel-resort/room4.jpg',
            type: 'family-suit'
        },
        {
            src: '/assets/images/hotel-resort/room5.jpg',
            thumb: '/assets/images/hotel-resort/room5.jpg',
            type: 'family-suit'
        },
        {
            src: '/assets/images/hotel-resort/room6.jpg',
            thumb: '/assets/images/hotel-resort/room6.jpg',
            type: 'modern-room'
        }
    ];
    constructor(
    ...
    open(img: string): void {
        // open lightbox
        const index = this.getItems().findIndex((d) =>
    ...
    getItems() {
        ...
        const imgs =
            this.items.filter(
                (d) => d.type.toLowerCase() === this.activeTab.toLowerCase()
            ) || [];
        return imgs;
    }
}
